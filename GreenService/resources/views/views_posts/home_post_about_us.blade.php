	...
	<div class="bottom-gioi-thieu">
		<div class="block-gioi-thieu">
			<div class="title-block-gioi-thieu">
				<h3>Giới thiệu công ty Khánh Huy</h3>
			</div>
			<div class="content-block-gioi-thieu">
				@foreach($all_posts_about_us as $key => $val)

				 <img class="embed-responsive" style="width: 300px;" alt="IMG Description" src="{{URL::TO('./public/uploads/PostsAboutUsImg/'.$val->post_about_us_img)}}"> 
				{!!$val->post_about_us_content!!}
				@endforeach
			</div>
		</div>
