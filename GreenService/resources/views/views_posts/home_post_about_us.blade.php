	...
	<div class="bottom-gioi-thieu">
		<div class="block-gioi-thieu">
			...
			<div class="content-block-gioi-thieu">
				 {{-- <img class="embed-responsive" alt="IMG Description" src="{{URL::TO('./public/uploads/PostsAboutUsImg/'.$all_posts_about_us->post_about_us_img)}}">  --}}
				{!!$all_posts_about_us->post_about_us_content!!}
			</div>
		</div>
