...
<html>
<head>
	<title>Duyệt hình ảnh bài viết kinh nghiệm năng lực làm việc</title>
...
<body>
	...
	<div id="fileExplorer">
		...
		<div class="thumbnail">
			<ul class="file-list">
				<li>
					<img src="{{asset('./public/uploads/PostsCriteriaImg/IMGckeditor/'.$file)}}" alt="img" title="{{asset('./public/uploads/PostsCriteriaImg/IMGckeditor/'.$file)}}" width="120" height="130">
					<br>
