...
<html>
<head>
	<title>Duyệt hình ảnh bài viết dự án</title>
...
<body>
	...
	<div id="fileExplorer">
		...
		<div class="thumbnail">
			<ul class="file-list">
				<li>
					<img src="{{asset('./public/uploads/PostsProjectImg/IMGckeditor/'.$file)}}" alt="img" title="{{asset('./public/uploads/PostsProjectImg/IMGckeditor/'.$file)}}" width="120" height="130">
					<br>
