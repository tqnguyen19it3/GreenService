        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>Thêm bài viết về dịch vụ</h3>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 ">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Bài viết <small>Dịch vụ</small></h2>
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form2" action="{{URL::TO('/save-posts-service')}}" enctype="multipart/form-data" method="post" data-parsley-validate class="form-horizontal form-label-left">
                    {{ csrf_field() }}
                    <div class="item form-group">
                      ...
                      <div class="col-md-9 col-sm-9 ">
                        <input type="text" id="slug" onkeyup="ChangeToSlug()" name="service_post_title" required="required" class="form-control ">
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-9 col-sm-9 ">
                        <input type="text" id="convert_slug" name="service_post_slug" required="required" class="form-control ">
                      </div>
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-9 col-sm-9 ">
                        <textarea class="form-control" rows="3" name="service_post_desc" placeholder="" required=""></textarea>
                      </div>
                    </div>
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 label-align" for="exampleInputImage1">Hình ảnh dịch vụ</label>
                        <input type="file" name="service_post_img" class="form-control" id="exampleInputImage1" required="" style="border: none;">
                    </div>
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 label-align">Nội dung dịch vụ <span class="required">*</span>
                      </label>
                      <div class="col-md-9 col-sm-9 ">
                        <textarea class="form-control" rows="5" id="ckeditor1" name="service_post_content" required="" placeholder=""></textarea>
                      </div> 
                    </div>
                    <div class="item form-group">
                      ...
                      <div class="col-md-9 col-sm-9 ">
                        <input type="text" id="Service keyword" name="service_post_metakeyword" required="required" class="form-control ">
                      </div>
                    </div>
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 label-align">Trạng thái <span class="required">*</span></label>
                      <div class="col-md-9 col-sm-9 ">
                        <select name="service_post_status" class="form-control">
